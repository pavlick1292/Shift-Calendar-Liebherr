...
object ShiftPeriodPdfExporter {
    ...
    fun export(context: Context, crewName: String, periods: List<ShiftPeriod>): File {
        val doc = PdfDocument()
        ...
        var y = 50f
        canvas.drawText("Состав: $crewName", 40f, y, titlePaint)
        y += 20f
        ...
        val file = File(dir, "shifts_${safeName}_${System.currentTimeMillis()}.pdf")
